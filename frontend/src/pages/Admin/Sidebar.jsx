...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    ...
    >
      ...
      <nav className="mt-5">
        <SidebarNavItem icon={<HiOutlineChartBar />} to="/admin/dashboard" text="Dashboard" />
        <SidebarNavItem icon={<HiOutlineUserGroup />} to="/admin/classes" text="Classes" />
        <SidebarNavItem icon={<HiOutlineAcademicCap />} to="/admin/students" text="Students" />
        <SidebarNavItem icon={<HiOutlineUser />} to="/admin/teachers" text="Teachers" />
        <SidebarNavItem icon={<HiOutlineCog />} to="/admin/profile" text="Profile" />
      </nav>
      <button
